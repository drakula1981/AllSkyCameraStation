...
; Generated by Tristan REY on 30/12/2021 (UTC)
;
[Setup]
AppID={{94c00ba6-7416-4e08-853b-1ae647d71544}
AppName=ASCOM SafetyMonitor SafetyMonitor Driver
AppVerName=ASCOM SafetyMonitor SafetyMonitor Driver 6.5.1.0
AppVersion=6.5.1.0
...
OutputDir="."
OutputBaseFilename="HRObservatory SafetyMonitor Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\SafetyMonitor\SafetyMonitor"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\SafetyMonitor\SafetyMonitor"
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.HyperRouge.SafetyMonitor.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.HyperRouge.SafetyMonitor.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.HyperRouge.SafetyMonitor.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.HyperRouge.SafetyMonitor.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.HyperRouge.SafetyMonitor.dll"""; Flags: runhidden 64bit; Check: IsWin64
