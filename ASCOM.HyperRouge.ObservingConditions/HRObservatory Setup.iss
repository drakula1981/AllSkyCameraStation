...
; Generated by Tristan REY on 28/12/2021 (UTC)
;
[Setup]
AppID={{49a9747d-bc50-4f22-9420-a46c42f2c3ce}
AppName=ASCOM HRObservatory ObservingConditions Driver
AppVerName=ASCOM HRObservatory ObservingConditions Driver 6.5.1
AppVersion=6.5.1
AppPublisher=Tristan REY <Tristan.Rey@gmail.com>
AppPublisherURL=mailto:Tristan.Rey@gmail.com
...
OutputDir="."
OutputBaseFilename="HRObservatory ObservingConditions Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\ObservingConditions\HRObservatory"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\ObservingConditions\HRObservatory"
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.HyperRouge.ObservingConditions.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.HyperRouge.ObservingConditions.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.HyperRouge.ObservingConditions.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.HyperRouge.ObservingConditions.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.HyperRouge.ObservingConditions.dll"""; Flags: runhidden 64bit; Check: IsWin64
