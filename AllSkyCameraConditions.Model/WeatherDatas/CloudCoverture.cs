...
[JsonObject("CloudCoverture")]
public class CloudCoverture : EntityBase {
   ...
   [JsonProperty("ambTemp")] public double? AmbientTemperature { get; init; }
   [JsonProperty("sensorAmbTemp")] public double MlxAmbientTemperature { get; init; }
   [JsonProperty("skyTemp")] public double SkyTemperature { get; init; }
   [JsonProperty("correctionSkyTempCoeff")] public double CorSkyTemperatureCoef { get; init; }
   ...
   [JsonProperty("cloudCover")] public double CloudCoveragePercent { get; init; }
   [JsonProperty("isSafe")] public bool IsSafe => CloudCoveragePercent <= acceptable_cloud;

   public CloudCoverture() : this(null, 0, 0) { }
   public CloudCoverture(DateTime measureDate, double? ambTemp, double sAmbTemp, double skyTemp) {
      Id = Guid.NewGuid();
   ...
   public CloudCoverture(double? ambTemp, double sAmbTemp, double skyTemp) {
      Id = Guid.NewGuid();
